...
public sealed class RoslynjectorGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext ctx)
    {
        ...
        ctx.RegisterSourceOutput(regs, static (spc, bindingInfos) =>
        {
            ...
            {
                if(bindingInfo is not ImplBindingInfo implBindingInfo)
                    continue;
                
                if(implBindingInfo.Impl is not INamedTypeSymbol namedTypeSymbol)
                    continue;
                ...
                {
                    stringBuilder.AppendLine($"//new {namedTypeSymbol}();");
                    continue;
                }

                stringBuilder.Append($"//new {namedTypeSymbol}(");
            ...
            spc.AddSource("RegDump.g.cs", stringBuilder.ToString());
        });
    }
